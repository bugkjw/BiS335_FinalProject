...
# LDA fitting on the candidate feature set
...
png(filename="./Result/LDA_4/CV_errors.png")
{par(mfrow = c(1,1))
...
{
  # Performance
  png(filename="./Result/LDA_4/LDA_training.png")
...
{
  # Performance
  png(filename="./Result/LDA_4/LDA_performance.png")
...
# Visualization
{
  ...
  # Data label
  png(filename="./Result/LDA_4/LDA_training_data_12.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_training_data_23.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_training_data_31.png")
...
{
  # Fitted model
  png(filename="./Result/LDA_4/LDA_training_fit_12.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_training_fit_23.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_training_fit_31.png")
...
}
{
  ...
  # Data label
  png(filename="./Result/LDA_4/LDA_test_data_12.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_test_data_23.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_test_data_31.png")
...
{ 
  # Prediction
  png(filename="./Result/LDA_4/LDA_test_fit_12.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_test_fit_23.png")
  ...
  dev.off()
  png(filename="./Result/LDA_4/LDA_test_fit_31.png")
